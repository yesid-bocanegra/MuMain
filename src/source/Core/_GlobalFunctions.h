...
#define g_CharacterCopyBuff(outObj, inObj) outObj->m_BuffMap.m_Buff = inObj->m_BuffMap.m_Buff
...
// TheBuffTimeControl
#define g_RegisterBuffTime(bufftype, curbufftime) TheBuffTimeControl().RegisterBuffTime(bufftype, curbufftime)

#define g_UnRegisterBuffTime(bufftype) TheBuffTimeControl().UnRegisterBuffTime(bufftype)

#define g_BuffStringTime(bufftype, timeText) TheBuffTimeControl().GetBuffStringTime(bufftype, timeText)

#define g_StringTime(time, timeText, issecond) TheBuffTimeControl().GetStringTime(time, timeText, issecond)
