...
static void UpdateCameraDistance()
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
            case 0:
                g_Camera.DistanceTarget = 1000.f;
                break;
            case 1:
                g_Camera.DistanceTarget = 1100.f;
                break;
            case 2:
                g_Camera.DistanceTarget = 1200.f;
                break;
            case 3:
                g_Camera.DistanceTarget = 1300.f;
                break;
            case 4:
                g_Camera.DistanceTarget = 1400.f;
                break;
            case 5:
                g_Camera.DistanceTarget = g_Direction.m_fCameraViewFar;
                break;
            }
