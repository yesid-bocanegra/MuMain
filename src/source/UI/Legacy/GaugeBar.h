...
public:
    ...
    void Create(int nGaugeWidth, int nGaugeHeight, int nGaugeTexID, const RECT* prcGauge = nullptr, int nBackWidth = 0,
                int nBackHeight = 0, int nBackTexID = -1, bool bShortenLeft = true, float fScaleX = 1.0f,
                float fScaleY = 1.0f);
