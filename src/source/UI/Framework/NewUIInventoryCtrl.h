...
public:
    ...
    bool Create(STORAGE_TYPE storageType, CNewUI3DRenderMng* pNew3DRenderMng, CNewUIItemMng* pNewItemMng,
                CNewUIObj* pOwner, int x, int y, int nColumn, int nRow, int nIndexOffset = 0);
    void Release();
