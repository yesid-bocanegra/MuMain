...
public:
    ...
    void ChangeButtonImgState(bool imgregister, int imgindex, bool overflg = false, bool isimgwidth = false,
...
inline void CNewUIButton::SetFont(HFONT hFont)
{
    m_hTextFont = hFont;
}
...
inline void CNewUIButton::SetToolTipFont(HFONT hFont)
{
