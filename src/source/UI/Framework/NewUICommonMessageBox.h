...
public:
    ...
    void SetInfo(DWORD dwTexType, float x, float y, float width, float height, DWORD dwSizeType = MSGBOX_BTN_CUSTOM,
...
#ifdef PBG_ADD_NAMETOPMSGBOX
    int SeparateText(const type_string& strMsg, DWORD dwColor = CLRDW_WHITE, BYTE byFontType = MSGBOX_FONT_NORMAL,
                     int _TextSize = MSGBOX_TEXT_MAXWIDTH);
#else  // PBG_ADD_NAMETOPMSGBOX
