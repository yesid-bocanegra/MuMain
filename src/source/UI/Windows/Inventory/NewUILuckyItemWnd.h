...
public:
    ...
    __inline void SetAct(eLUCKYITEMTYPE _eAct)
    {
        m_eType = _eAct;
    }
    __inline void SetPos(int _nX, int _nY)
    {
        m_ptPos.x = _nX, m_ptPos.y = _nY;
    }
    __inline void SetSize(float _fX, float _fY)
    {
        m_fSizeX = _fX, m_fSizeY = _fY;
    }
