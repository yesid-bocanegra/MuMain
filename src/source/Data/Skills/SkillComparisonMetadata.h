...
inline constexpr FieldInfo FIELDS_BEFORE_ARRAYS[] = {
    ...
    {"AbilityGuage", FieldType::Word, offsetof(SKILL_ATTRIBUTE, AbilityGuage), sizeof(SKILL_ATTRIBUTE::AbilityGuage),
     -1},
    ...
    {"SkillUseType", FieldType::Byte, offsetof(SKILL_ATTRIBUTE, SkillUseType), sizeof(SKILL_ATTRIBUTE::SkillUseType),
     -1},
...
inline constexpr FieldInfo ARRAY_FIELDS[] = {
    {"RequireDutyClass[0]", FieldType::Byte, offsetof(SKILL_ATTRIBUTE, RequireDutyClass) + sizeof(BYTE) * 0,
     sizeof(BYTE), 0},
    {"RequireDutyClass[1]", FieldType::Byte, offsetof(SKILL_ATTRIBUTE, RequireDutyClass) + sizeof(BYTE) * 1,
     sizeof(BYTE), 1},
    {"RequireDutyClass[2]", FieldType::Byte, offsetof(SKILL_ATTRIBUTE, RequireDutyClass) + sizeof(BYTE) * 2,
     sizeof(BYTE), 2},
