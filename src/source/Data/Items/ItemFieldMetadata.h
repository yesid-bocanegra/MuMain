...
static const ItemFieldDescriptor s_descriptors[] = {
    ...
    ITEM_FIELDS_SIMPLE(MAKE_SIMPLE_FIELD_DESCRIPTOR) ITEM_FIELDS_ARRAYS(MAKE_ARRAY_FIELD_DESCRIPTOR)};
}
...
inline void RenderFieldByDescriptor(const ItemFieldDescriptor& desc, TColumns* cols, ITEM_ATTRIBUTE& item, int& colIdx,
                                    int itemIndex, bool& rowInteracted, bool isVisible)
{
