...
inline constexpr FieldInfo SIMPLE_FIELDS[] = {
    ...
    {"m_wSkillIndex", FieldType::Word, offsetof(ITEM_ATTRIBUTE, m_wSkillIndex), sizeof(ITEM_ATTRIBUTE::m_wSkillIndex),
     -1},
    ...
    {"SuccessfulBlocking", FieldType::Byte, offsetof(ITEM_ATTRIBUTE, SuccessfulBlocking),
     sizeof(ITEM_ATTRIBUTE::SuccessfulBlocking), -1},
    ...
    {"RequireStrength", FieldType::Word, offsetof(ITEM_ATTRIBUTE, RequireStrength),
     sizeof(ITEM_ATTRIBUTE::RequireStrength), -1},
    {"RequireDexterity", FieldType::Word, offsetof(ITEM_ATTRIBUTE, RequireDexterity),
     sizeof(ITEM_ATTRIBUTE::RequireDexterity), -1},
    {"RequireEnergy", FieldType::Word, offsetof(ITEM_ATTRIBUTE, RequireEnergy), sizeof(ITEM_ATTRIBUTE::RequireEnergy),
     -1},
    {"RequireVitality", FieldType::Word, offsetof(ITEM_ATTRIBUTE, RequireVitality),
     sizeof(ITEM_ATTRIBUTE::RequireVitality), -1},
    {"RequireCharisma", FieldType::Word, offsetof(ITEM_ATTRIBUTE, RequireCharisma),
     sizeof(ITEM_ATTRIBUTE::RequireCharisma), -1},
