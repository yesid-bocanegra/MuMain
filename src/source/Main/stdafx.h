...
// Reference render resolution. The original game logic was authored against a
// 640x480 viewport and many UI / projection paths still scale relative to it.
// Defined here so the new Camera/* code from PR #335 (which references these
// constants directly) compiles unchanged. Mirrors origin/main's stdafx.h:149.
