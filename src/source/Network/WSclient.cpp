...
void ReceiveServerConnect(const BYTE* ReceiveBuffer)
{
    ...
    wchar_t Text[100];
    mu_swprintf(Text, GlobalText[481], IP, Data->Port);
...
void ReceiveMuHelperStatusUpdate(std::span<const BYTE> ReceiveBuffer)
{
    ...
    else
    {
        ...
        if (pMuHelperStatus->Money > 0 && pMuHelperStatus->ConsumeMoney)
        {
            ...
            wchar_t Text[100];
            mu_swprintf(Text, GlobalText[3586], iTotalCost);
            g_pSystemLogBox->AddText(Text, SEASON3B::TYPE_SYSTEM_MESSAGE);
        }
    }
...
void ReceiveNotice(const BYTE* ReceiveBuffer)
{
    ...
    else if (Data->Result == 2)
    {
        ...
        mu_swprintf(FullText, GlobalText[483], Text);
...
BOOL ReceiveDieExp(const BYTE* ReceiveBuffer, BOOL bEncrypted)
{
    ...
    if (Exp > 0)
    {
        ...
        if (gCharacterManager.IsMasterLevel(Hero->Class) == true)
        {
            ...
            mu_swprintf(Text, GlobalText[486], Exp);
        g_pSystemLogBox->AddText(Text, SEASON3B::TYPE_SYSTEM_MESSAGE);
    }
...
BOOL ReceiveDieExpLarge(const BYTE* ReceiveBuffer, BOOL bEncrypted)
{
    ...
    if (addedExperience > 0)
    {
        ...
        if (experienceType == eExperienceType_Master)
        {
            mu_swprintf(Text, GlobalText[1750], addedExperience);
        }
        else
        {
            mu_swprintf(Text, GlobalText[486], addedExperience);
        }
...
void ReceiveMixExtended(std::span<const BYTE> ReceiveBuffer)
{
    ...
    case 0:
    {
        ...
        case SEASON3A::MIXTYPE_SEED_SPHERE:
            mu_swprintf(szText, GlobalText[594]);
        ...
        case SEASON3A::MIXTYPE_OSBOURNE:
            mu_swprintf(szText, GlobalText[2105], GlobalText[2061]);
            g_pSystemLogBox->AddText(szText, SEASON3B::TYPE_ERROR_MESSAGE);
            break;
        case SEASON3A::MIXTYPE_JERRIDON:
            mu_swprintf(szText, GlobalText[2105], GlobalText[2062]);
            g_pSystemLogBox->AddText(szText, SEASON3B::TYPE_ERROR_MESSAGE);
            break;
        case SEASON3A::MIXTYPE_ELPIS:
            mu_swprintf(szText, GlobalText[2112], GlobalText[2063]);
            g_pSystemLogBox->AddText(szText, SEASON3B::TYPE_ERROR_MESSAGE);
            break;
        case SEASON3A::MIXTYPE_CHAOS_CARD:
            mu_swprintf(szText, GlobalText[2112], GlobalText[2265]);
            g_pSystemLogBox->AddText(szText, SEASON3B::TYPE_ERROR_MESSAGE);
            break;
        case SEASON3A::MIXTYPE_CHERRYBLOSSOM:
            mu_swprintf(szText, GlobalText[2112], GlobalText[2560]);
            g_pSystemLogBox->AddText(szText, SEASON3B::TYPE_ERROR_MESSAGE);
            break;
        }
    }
    ...
    case 1:
    {
        ...
        case SEASON3A::MIXTYPE_EXTRACT_SEED:
        case SEASON3A::MIXTYPE_SEED_SPHERE:
            mu_swprintf(szText, GlobalText[595]);
            ...
            // 				break;
        case SEASON3A::MIXTYPE_OSBOURNE:
            mu_swprintf(szText, GlobalText[2106], GlobalText[2061]);
            g_pSystemLogBox->AddText(szText, SEASON3B::TYPE_SYSTEM_MESSAGE);
            break;
        case SEASON3A::MIXTYPE_JERRIDON:
            mu_swprintf(szText, GlobalText[2106], GlobalText[2062]);
            g_pSystemLogBox->AddText(szText, SEASON3B::TYPE_SYSTEM_MESSAGE);
            break;
        case SEASON3A::MIXTYPE_ELPIS:
            mu_swprintf(szText, GlobalText[2113], GlobalText[2063]);
            g_pSystemLogBox->AddText(szText, SEASON3B::TYPE_SYSTEM_MESSAGE);
            break;
        case SEASON3A::MIXTYPE_CHAOS_CARD:
            mu_swprintf(szText, GlobalText[2113], GlobalText[2265]);
            g_pSystemLogBox->AddText(szText, SEASON3B::TYPE_SYSTEM_MESSAGE);
            break;
        case SEASON3A::MIXTYPE_CHERRYBLOSSOM:
            mu_swprintf(szText, GlobalText[2113], GlobalText[2560]);
            g_pSystemLogBox->AddText(szText, SEASON3B::TYPE_SYSTEM_MESSAGE);
            break;
        }
...
void ReceivePK(const BYTE* ReceiveBuffer)
{
    ...
    {
        wchar_t szTemp[100];
        mu_swprintf(szTemp, L"%ls %d%ls", GlobalText[490], 1, GlobalText[491]);
    ...
    {
        wchar_t szTemp[100];
        mu_swprintf(szTemp, L"%ls %d%ls", GlobalText[490], 2, GlobalText[491]);
        wcscat(message, szTemp);
        g_pSystemLogBox->AddText(message, SEASON3B::TYPE_ERROR_MESSAGE);
    }
    break;
...
void ReceivePartyResult(const BYTE* ReceiveBuffer)
{
    ...
    {
    case 0:
        g_pSystemLogBox->AddText(GlobalText[497], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 1:
        g_pSystemLogBox->AddText(GlobalText[498], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 2:
        g_pSystemLogBox->AddText(GlobalText[499], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 3:
        g_pSystemLogBox->AddText(GlobalText[500], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 4:
        g_pSystemLogBox->AddText(GlobalText[501], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 5:
        g_pSystemLogBox->AddText(GlobalText[502], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 6:
        g_pSystemLogBox->AddText(GlobalText[2990], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 7:
        g_pSystemLogBox->AddText(GlobalText[2997], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 8:
        g_pSystemLogBox->AddText(GlobalText[2998], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    }
}
...
void ReceivePartyGetItem(const BYTE* ReceiveBuffer)
{
    ...
    if ((Data->ItemInfo & 0x10000))
        mu_swprintf(itemName, L"%ls ", GlobalText[620]);
    else if ((Data->ItemInfo & 0x20000))
        mu_swprintf(itemName, L"%ls ", GlobalText[1089]);

    int itemLevel = Data->ItemLevel;
    GetItemName(itemType, itemLevel, Text);
    wcscat(itemName, Text);
    if ((Data->ItemInfo & 0x02000))
        wcscat(itemName, GlobalText[176]);
    if ((Data->ItemInfo & 0x08000))
        wcscat(itemName, GlobalText[177]);
    if ((Data->ItemInfo & 0x04000))
        wcscat(itemName, GlobalText[178]);

    mu_swprintf(Text, L"%ls : %ls %ls", c->ID, itemName, GlobalText[918]);
...
void ReceiveGuildResult(const BYTE* ReceiveBuffer)
{
    ...
    {
    case 0:
        g_pSystemLogBox->AddText(GlobalText[503], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 1:
        g_pSystemLogBox->AddText(GlobalText[504], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 2:
        g_pSystemLogBox->AddText(GlobalText[505], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 3:
        g_pSystemLogBox->AddText(GlobalText[506], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 4:
        g_pSystemLogBox->AddText(GlobalText[507], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 5:
        g_pSystemLogBox->AddText(GlobalText[508], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 6:
        g_pSystemLogBox->AddText(GlobalText[509], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 7:
        g_pSystemLogBox->AddText(GlobalText[510], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 0xA1:
        g_pSystemLogBox->AddText(GlobalText[2992], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 0xA2:
        g_pSystemLogBox->AddText(GlobalText[2995], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 0xA3:
        g_pSystemLogBox->AddText(GlobalText[2996], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    }
}
...
void ReceiveGuildLeave(const BYTE* ReceiveBuffer)
{
    ...
    {
    case 0:
        g_pSystemLogBox->AddText(GlobalText[511], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 1:
        g_pSystemLogBox->AddText(GlobalText[512], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 2:
        g_pSystemLogBox->AddText(GlobalText[513], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 3:
        g_pSystemLogBox->AddText(GlobalText[514], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 4:
        g_pSystemLogBox->AddText(GlobalText[515], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 5:
        g_pSystemLogBox->AddText(GlobalText[568], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    }
...
void ReceiveCreateGuildResult(const BYTE* ReceiveBuffer)
{
    ...
    {
    case 0:
        g_pSystemLogBox->AddText(GlobalText[516], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 2:
        g_pSystemLogBox->AddText(GlobalText[517], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 3:
        g_pSystemLogBox->AddText(GlobalText[518], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 4:
        g_pSystemLogBox->AddText(GlobalText[940], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 5:
        g_pSystemLogBox->AddText(GlobalText[941], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 6:
        g_pSystemLogBox->AddText(GlobalText[942], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 1:
...
void ReceiveDeclareWarResult(const BYTE* ReceiveBuffer)
{
    ...
    {
    case 0:
        g_pSystemLogBox->AddText(GlobalText[519], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 1:
        g_pSystemLogBox->AddText(GlobalText[520], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 2:
        g_pSystemLogBox->AddText(GlobalText[521], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 3:
        g_pSystemLogBox->AddText(GlobalText[522], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 4:
        g_pSystemLogBox->AddText(GlobalText[523], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 5:
        g_pSystemLogBox->AddText(GlobalText[524], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    case 6:
        g_pSystemLogBox->AddText(GlobalText[525], SEASON3B::TYPE_ERROR_MESSAGE);
        break;
    }
...
void ReceiveGuildBeginWar(const BYTE* ReceiveBuffer)
{
    ...
    if (Data->Type == 0)
    {
        mu_swprintf(Text, GlobalText[526], GuildWarName);
    }
    else
    {
        mu_swprintf(Text, GlobalText[533], GuildWarName);
        EnableSoccer = true;
    }
...
void ReceiveGuildEndWar(const BYTE* ReceiveBuffer)
{
    ...
    case 0:
        ...
        wprintf(Text, GlobalText[527]);
        break;
    case 1:
        wprintf(Text, GlobalText[528]);
        Win = 2;
        break;
    case 2:
        wprintf(Text, GlobalText[529]);
        Win = 2;
        break;
    case 3:
        wprintf(Text, GlobalText[530]);
        break;
    case 4:
        wprintf(Text, GlobalText[531]);
        Win = 2;
        break;
    case 5:
        wprintf(Text, GlobalText[532]);
        break;
    case 6:
        wprintf(Text, GlobalText[480]);
        Win = 1;
        break;
    default:
        mu_swprintf(Text, L"");
...
void ReceiveGuildRelationShipResult(const BYTE* ReceiveBuffer)
{
    ...
    if (pData->byResult == 0x01)
    {
        ...
        {
            if (pData->byRequestType == 0x01)
                wcscpy(szTemp, GlobalText[1383]);
            else
                wcscpy(szTemp, GlobalText[1384]);
        }
    }
...
void ReceiveSoccerGoal(const BYTE* ReceiveBuffer)
{
    ...
    if (Data->Value == HeroSoccerTeam)
        mu_swprintf(Text, GlobalText[534], GuildMark[Hero->GuildMarkIndex].GuildName);
    else
        mu_swprintf(Text, GlobalText[534], GuildWarName);
    g_pSystemLogBox->AddText(Text, SEASON3B::TYPE_SYSTEM_MESSAGE);
}
...
void Receive_Master_LevelUp(const BYTE* ReceiveBuffer, int Size)
{
    ...
    if (iExp > 0)
    {
        mu_swprintf(szText, GlobalText[1750], iExp);
        g_pSystemLogBox->AddText(szText, SEASON3B::TYPE_SYSTEM_MESSAGE);
    }
...
void ReceiveServerCommand(const BYTE* ReceiveBuffer)
{
    ...
    {
        wchar_t strText[128];
        mu_swprintf(strText, GlobalText[2043], GlobalText[39]);
    ...
    {
        wchar_t strText[128];
        mu_swprintf(strText, GlobalText[2043], GlobalText[56]);
        SEASON3B::CreateOkMessageBox(strText);
    }
    break;
    case 57:
    {
        wchar_t strText[128];
        mu_swprintf(strText, GlobalText[2043], GlobalText[57]);
        SEASON3B::CreateOkMessageBox(strText);
    }
    break;
    case 58:
...
void ReceiveGemMixResult(const BYTE* ReceiveBuffer)
{
    ...
    case 3:
    {
        mu_swprintf(sBuf, L"%ls%ls %ls", GlobalText[1801], GlobalText[1816], GlobalText[868]);
...
void ReceiveGemUnMixResult(const BYTE* ReceiveBuffer)
{
    ...
    case 5:
    {
        mu_swprintf(sBuf, L"%ls%ls %ls", GlobalText[1800], GlobalText[1816], GlobalText[868]);
        g_pSystemLogBox->AddText(sBuf, SEASON3B::TYPE_SYSTEM_MESSAGE);
        COMGEM::GetBack();
    }
    break;
...
void ReceiveDevilSquareOpenTime(const BYTE* ReceiveBuffer)
{
    ...
    {
        wchar_t strText[128];
        mu_swprintf(strText, GlobalText[644], (int)Data->Value);
        SEASON3B::CreateOkMessageBox(strText);
    }
}
...
void ReceiveMoveToEventMatchResult(const BYTE* ReceiveBuffer)
{
    ...
    {
        wchar_t strText[128];
        mu_swprintf(strText, GlobalText[852], GlobalText[1146]);
        SEASON3B::CreateOkMessageBox(strText);
    }
    break;
    ...
    {
        wchar_t strText[128];
        mu_swprintf(strText, GlobalText[853], GlobalText[1146], MAX_BLOOD_CASTLE_MEN);
        SEASON3B::CreateOkMessageBox(strText);
    }
    break;
    ...
    {
        wchar_t strText[128];
        mu_swprintf(strText, GlobalText[867], 6);
        SEASON3B::CreateOkMessageBox(strText);
    }
    break;
    case 7:
    ...
    {
        wchar_t strText[128];
        mu_swprintf(strText, GlobalText[852], GlobalText[1147]);
        SEASON3B::CreateOkMessageBox(strText);
    }
    break;
    ...
    {
        wchar_t strText[128];
        mu_swprintf(strText, GlobalText[853], GlobalText[1147], MAX_CHAOS_CASTLE_MEN);
        SEASON3B::CreateOkMessageBox(strText);
    }
    break;
    }
...
void ReceiveEventZoneOpenTime(const BYTE* ReceiveBuffer)
{
    ...
    if (Data->Value == 1)
    {
        ...
        {
            wchar_t strText[128];
            mu_swprintf(strText, GlobalText[644], (int)Data->KeyH);
            SEASON3B::CreateOkMessageBox(strText);
        }
    }
    else if (Data->Value == 2)
    {
        ...
        if (0 == Data->KeyH)
        {
            mu_swprintf(strText, GlobalText[850], GlobalText[1146]);
        }
        else
        {
            mu_swprintf(strText, GlobalText[851], (int)Data->KeyH, GlobalText[1146]);
        }
        SEASON3B::CreateOkMessageBox(strText);
    }
    else if (Data->Value == 4)
    {
        ...
        if (0 == time)
        {
            ...
            mu_swprintf(szOpenTime1, GlobalText[850], GlobalText[1147]);
            mu_swprintf(szOpenTime2, GlobalText[1156], GlobalText[1147], Data->KeyM, 100);
        ...
        else
        {
            ...
            mu_swprintf(szOpenTime, GlobalText[1164], Hour);
            mu_swprintf(Text, GlobalText[851], Mini, GlobalText[1147]);
    ...
    else if (Data->Value == 5)
    {
        ...
        if (0 == Data->KeyH)
        {
            mu_swprintf(strText, GlobalText[850], GlobalText[2369]);
        }
        else
        {
            mu_swprintf(strText, GlobalText[851], (int)Data->KeyH, GlobalText[2369]);
        }
        SEASON3B::CreateOkMessageBox(strText);
    }
}
...
void ReceiveDuelStart(const BYTE* ReceiveBuffer)
{
    ...
    if (Data->nResult == 0)
    {
        ...
        mu_swprintf(szMessage, GlobalText[912], g_DuelMgr.GetDuelPlayerID(DUEL_ENEMY));
    ...
    {
        g_DuelMgr.SetDuelPlayer(DUEL_ENEMY, MAKEWORD(Data->bIndexL, Data->bIndexH), playerName);
        mu_swprintf(szMessage, GlobalText[913], g_DuelMgr.GetDuelPlayerID(DUEL_ENEMY));
        g_pSystemLogBox->AddText(szMessage, SEASON3B::TYPE_ERROR_MESSAGE);
    }
    ...
    {
        g_DuelMgr.SetDuelPlayer(DUEL_ENEMY, MAKEWORD(Data->bIndexL, Data->bIndexH), playerName);
        mu_swprintf(szMessage, GlobalText[2704], 30);
        g_pSystemLogBox->AddText(szMessage, SEASON3B::TYPE_ERROR_MESSAGE);
    }
    else if (Data->nResult == 30)
    {
        g_DuelMgr.SetDuelPlayer(DUEL_ENEMY, MAKEWORD(Data->bIndexL, Data->bIndexH), playerName);
        mu_swprintf(szMessage, GlobalText[1811]);
        g_pSystemLogBox->AddText(szMessage, SEASON3B::TYPE_ERROR_MESSAGE);
    }
}
...
void ReceiveDuelResult(const BYTE* ReceiveBuffer)
{
    ...
    wchar_t szMessage[256];
    mu_swprintf(szMessage, GlobalText[2689], 10);
    g_pSystemLogBox->AddText(szMessage, SEASON3B::TYPE_SYSTEM_MESSAGE);
...
void NotifySoldItem(const BYTE* ReceiveBuffer)
{
    ...
    CMultiLanguage::ConvertFromUtf8(szId, Header->szId, MAX_USERNAME_SIZE);
    wchar_t Text[100];
    mu_swprintf(Text, GlobalText[1122], szId);
    g_pSystemLogBox->AddText(Text, SEASON3B::TYPE_SYSTEM_MESSAGE);
}
...
void ReceiveFriendList(const BYTE* ReceiveBuffer)
{
    ...
    if (Header->MemoCount > 0)
    {
        ...
        mu_swprintf(temp, GlobalText[1072], Header->MemoCount, Header->MaxMemo);
...
void ReceiveRequestAcceptAddFriend(const BYTE* ReceiveBuffer)
{
    ...
    mu_swprintf(szText, L"%ls %ls", szText, GlobalText[1051]); // " has requested to list you as a friend."
...
void ReceiveLetterSendResult(const BYTE* ReceiveBuffer)
{
    ...
    case 0x01:
    {
        ...
        wchar_t temp[MAX_TEXT_LENGTH + 1];
        mu_swprintf(temp, GlobalText[1046], g_cdwLetterCost);
        g_pSystemLogBox->AddText(temp, SEASON3B::TYPE_SYSTEM_MESSAGE);
    }
    break;
    case 0x02:
...
void ReceiveLetterText(std::span<const BYTE> ReceiveBuffer, bool isCached)
{
    ...
    mu_swprintf(tempTxt, GlobalText[1054], pLetterHead->m_szText);
    DWORD dwUIID = 0;
...
void ReceiveUseStateItem(const BYTE* ReceiveBuffer)
{
    ...
    case 0x00:
        if (fruit >= 0 && fruit <= 4)
        {
            ...
            mu_swprintf(strText, GlobalText[379], GlobalText[index], point, GlobalText[1412]);
            SEASON3B::CreateOkMessageBox(strText);
        }
        break;
    ...
    case 0x02:
    {
        mu_swprintf(strText, GlobalText[1904], GlobalText[1412]);
        SEASON3B::CreateOkMessageBox(strText);
    }
    break;
    case 0x03:
        if (fruit >= 0 && fruit <= 4)
        {
            ...
            wchar_t strText[128];
            mu_swprintf(strText, GlobalText[379], GlobalText[index], point, GlobalText[1903]);
            SEASON3B::CreateOkMessageBox(strText);
        }
        break;
    ...
    {
        wchar_t strText[128];
        mu_swprintf(strText, GlobalText[1904], GlobalText[1903]);
        SEASON3B::CreateOkMessageBox(strText);
    }
    break;
    case 0x06:
        if (fruit >= 0 && fruit <= 4)
        {
            ...
            mu_swprintf(Text, GlobalText[379], GlobalText[index], point, GlobalText[1903]);
    ...
    case 0x08:
        wchar_t Text[MAX_GLOBAL_TEXT_STRING];
        mu_swprintf(Text, GlobalText[1904], GlobalText[1903]);
        SEASON3B::CreateOkMessageBox(Text);
        break;
    case 0x10:
    {
...
void ReceiveCrownSwitchState(const BYTE* ReceiveBuffer)
{
    ...
    case 2:
    {
        ...
        if (pMsgBox)
        {
            ...
            {
                mu_swprintf(strText, GlobalText[1486], pCha->ID);
            }
            else
            {
                mu_swprintf(strText, GlobalText[1487]);
            }
            pMsgBox->AddMsg(strText);

            mu_swprintf(strText, GlobalText[1488], CrownSwitch->ID);
            pMsgBox->AddMsg(strText);
        }
    }
    break;
...
void ReceiveCrownRegist(const BYTE* ReceiveBuffer)
{
    ...
    case 0:
    {
        ...
        if (pMsgBox)
        {
            ...
            if (iTime >= 59)
                iTime = 59;
            mu_swprintf(strText, GlobalText[1980], GlobalText[1489], iTime);
            pMsgBox->AddMsg(strText);
    ...
    case 2:
    {
        ...
        if (pMsgBox)
        {
            ...
            if (iTime >= 59)
                iTime = 59;
            mu_swprintf(strText, GlobalText[1980], GlobalText[1491], iTime);
            pMsgBox->AddMsg(strText);
        }
    }
    break;
...
void ReceiveBattleCastleProcess(const BYTE* ReceiveBuffer)
{
    ...
    {
        wchar_t Text[100];
        mu_swprintf(Text, GlobalText[1496], guildName);
        CreateNotice(Text, 1);
    }
    break;
    ...
    case 1:
    {
        ...
        wchar_t Text2[100];
        mu_swprintf(Text2, GlobalText[1497], guildName);
...
bool ReceiveEnterDoppelGangerEvent(const BYTE* ReceiveBuffer)
{
    ...
    case 1:
        ...
        break;
    case 2:
        mu_swprintf(szText, GlobalText[2864]);
        g_pSystemLogBox->AddText(szText, SEASON3B::TYPE_ERROR_MESSAGE);
        g_pDoppelGangerWindow->LockEnterButton(TRUE);
        break;
    case 3:
        mu_swprintf(szText, GlobalText[2865]);
        g_pSystemLogBox->AddText(szText, SEASON3B::TYPE_ERROR_MESSAGE);
        g_pDoppelGangerWindow->LockEnterButton(TRUE);
        break;
    case 4:
...
bool ReceiveResultEmpireGuardian(const BYTE* ReceiveBuffer)
{
    ...
    case 2:
    {
        ...
        mu_swprintf(szText, GlobalText[861], Data->Exp);
        pMsgBox->AddMsg(szText, RGBA(255, 255, 255, 255), SEASON3B::MSGBOX_FONT_NORMAL);
    }
    break;
    }
...
void InsertBuffLogicalEffect(eBuffState buff, OBJECT* o, const int bufftime)
{
    if (o && o == &Hero->Object)
    {
        ...
        case eBuff_LuckOfSanta:
        {
            ...
            {
                mu_swprintf(_Temp, GlobalText[2594], 30);
            ...
            {
                mu_swprintf(_Temp, GlobalText[2595], 100);
                g_pSystemLogBox->AddText(_Temp, SEASON3B::TYPE_SYSTEM_MESSAGE);
            ...
            {
                mu_swprintf(_Temp, GlobalText[2598], 15);
                g_pSystemLogBox->AddText(_Temp, SEASON3B::TYPE_SYSTEM_MESSAGE);
            }
            else if (buff == eBuff_LuckOfSanta)
            {
                mu_swprintf(_Temp, GlobalText[2599], 10);
                g_pSystemLogBox->AddText(_Temp, SEASON3B::TYPE_SYSTEM_MESSAGE);
            }
            else if (buff == eBuff_CureOfSanta)
            {
                mu_swprintf(_Temp, GlobalText[2592], 500);
                g_pSystemLogBox->AddText(_Temp, SEASON3B::TYPE_SYSTEM_MESSAGE);
            }
            else if (buff == eBuff_SafeGuardOfSanta)
            {
                mu_swprintf(_Temp, GlobalText[2593], 500);
                g_pSystemLogBox->AddText(_Temp, SEASON3B::TYPE_SYSTEM_MESSAGE);
            }
        }
        break;
