...
public:
    struct INTERPOLATE_FACTOR
    {
        ...
        vec3_t v3Start = {};
        vec3_t v3End = {};
        INTERPOLATE_FACTOR(const float fRateStart_, const float fRateEnd_, const vec3_t& v3Start_, const vec3_t& v3End_)
        {
    ...
    struct INTERPOLATE_FACTOR_F
    {
        ...
        float fStart;
        float fEnd;
        INTERPOLATE_FACTOR_F(const float fRateStart_, const float fRateEnd_, const float& fStart_, const float& fEnd_)
        {
            fRateStart = fRateStart_;
            fRateEnd = fRateEnd_;
