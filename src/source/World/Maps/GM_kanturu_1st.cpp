...
bool M37Kanturu1st::RenderKanturu1stObjectVisual(OBJECT* pObject, BMD* pModel)
{
    ...
    case 62:
        if (pObject->HiddenMesh != -2)
        {
            ...
            for (int i = 0; i < 20; ++i)
                CreateParticleFpsChecked(BITMAP_CLOUD, pObject->Position, pObject->Angle, Light, 20, pObject->Scale,
                                         pObject);
        }
        break;
    case 70:
    ...
    case 85:
        ...
        pModel->RenderMesh(3, RENDER_TEXTURE | RENDER_BRIGHT, pObject->Alpha, pObject->BlendMesh,
                           pObject->BlendMeshLight, pObject->BlendMeshTexCoordU, pObject->BlendMeshTexCoordV);
        pModel->RenderMesh(3, RENDER_CHROME | RENDER_DARK, pObject->Alpha, pObject->BlendMesh, pObject->BlendMeshLight,
                           pObject->BlendMeshTexCoordU, pObject->BlendMeshTexCoordV, BITMAP_CHROME);
        pModel->EndRender();
        break;
    case 92:
    {
        ...
        pModel->TransformPosition(BoneTransform[1], EndRelative, StartPos, false);
        pModel->TransformPosition(BoneTransform[2], EndRelative, EndPos, false);
        if (rand() % 30 == 1)
            CreateJoint(BITMAP_JOINT_THUNDER, StartPos, EndPos, pObject->Angle, 18, NULL, 50.f);
    }
    break;
    case 96:
        pModel->StreamMesh = 0;
        glAlphaFunc(GL_GREATER, 0.0f);
        pModel->RenderMesh(0, RENDER_TEXTURE, 1.0f, pObject->BlendMesh, pObject->BlendMeshLight,
                           pObject->BlendMeshTexCoordU, -(int)WorldTime % 20000 * 0.00005f);
    ...
    case 105:
    {
        ...
        CreateParticleFpsChecked(BITMAP_ENERGY, Position, pObject->Angle, Light, 0, 1.5f);
        ...
        if (rand_fps_check(20))
            CreateJoint(BITMAP_JOINT_THUNDER, StartPos, EndPos, pObject->Angle, 8, NULL, 40.f);
    }
    break;
    case 107:
        if (pObject->HiddenMesh != -2)
    ...
    case 108:
        if (pObject->HiddenMesh != -2)
        {
            ...
            for (int i = 0; i < 20; ++i)
                CreateParticleFpsChecked(BITMAP_CLOUD, pObject->Position, pObject->Angle, Light, 7, pObject->Scale,
                                         pObject);
        }
        break;
    case 110:
...
bool M37Kanturu1st::RenderKanturu1stMonsterObjectMesh(OBJECT* o, BMD* b, int ExtraMon)
{
    ...
    case MODEL_BERSERK:
    {
        ...
        b->RenderMesh(0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 0, fLumi, o->BlendMeshTexCoordU,
                      o->BlendMeshTexCoordV, BITMAP_BERSERK_EFFECT);
        b->RenderMesh(1, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 1, fLumi, o->BlendMeshTexCoordU,
                      o->BlendMeshTexCoordV, BITMAP_BERSERK_WP_EFFECT);
    ...
    case MODEL_BLADE_HUNTER:
    {
        if (o->CurrentAction != MONSTER01_DIE)
        {
            ...
            b->RenderBody(RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                          o->BlendMeshTexCoordV, o->HiddenMesh);
            b->RenderMesh(0, RENDER_TEXTURE | RENDER_BRIGHT, o->Alpha, 0, fLumi, o->BlendMeshTexCoordU,
                          o->BlendMeshTexCoordV, BITMAP_BLADEHUNTER_EFFECT);
        }
        else
        {
            if (o->Alpha < 0.f)
    ...
    case MODEL_SATYROS:
    {
        ...
        b->RenderBody(RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU,
                      o->BlendMeshTexCoordV, o->HiddenMesh);
        b->StreamMesh = 1;
        b->RenderMesh(1, RENDER_TEXTURE | RENDER_BRIGHT, 1.f, 0, o->BlendMeshLight, o->BlendMeshTexCoordU,
                      WorldTime * 0.0005f);
        b->RenderMesh(3, RENDER_CHROME | RENDER_BRIGHT, 1.f, 0, o->BlendMeshLight, o->BlendMeshTexCoordU,
        ...
        b->RenderMesh(4, RENDER_TEXTURE | RENDER_BRIGHT, 1.f, 2, o->BlendMeshLight, WorldTime * 0.0001f,
                      -WorldTime * 0.0005f);
        b->EndRender();
        return true;
    }
...
bool M37Kanturu1st::RenderKanturu1stMonsterVisual(CHARACTER* c, OBJECT* o, BMD* b)
{
    ...
    case MODEL_BERSERK:
    {
        ...
        if (o->CurrentAction == MONSTER01_DIE || o->CurrentAction == MONSTER01_ATTACK1 ||
        ...
        CreateParticle(BITMAP_SMOKE, vPos, o->Angle, o->Light, 42, o->Scale);
    ...
    case MODEL_GENOCIDER:
    {
        ...
        if (o->CurrentAction == MONSTER01_WALK && rand_fps_check(1))
        {
            ...
            CreateParticle(BITMAP_SMOKE + 1, vPos, o->Angle, o->Light, 1, o->Scale);
    ...
    case MODEL_BERSERKER_WARRIOR:
    {
        ...
        Vector(0.f, 0.f, 0.f, vRelative);
        BoneManager::GetBonePosition(o, L"BERSERK_MOUTH", vRelative, vPos);
        CreateParticleFpsChecked(BITMAP_SMOKE, vPos, o->Angle, o->Light, 42, o->Scale);
    }
        return true;
    case MODEL_KENTAUROS_WARRIOR:
    {
...
void M37Kanturu1st::MoveKanturu1stBlurEffect(CHARACTER* c, OBJECT* o, BMD* b)
{
    ...
    case MODEL_SATYROS:
    {
        if ((o->AnimationFrame >= 3.6f && o->AnimationFrame <= 6.0f && o->CurrentAction == MONSTER01_ATTACK1) ||
            (o->AnimationFrame >= 3.6f && o->AnimationFrame <= 6.0f && o->CurrentAction == MONSTER01_ATTACK2))
        {
            vec3_t Light;
    ...
    case MODEL_BERSERK:
    {
        if ((o->AnimationFrame >= 3.5f && o->AnimationFrame <= 6.7f && o->CurrentAction == MONSTER01_ATTACK1) ||
            (o->AnimationFrame >= 3.5f && o->AnimationFrame <= 6.7f && o->CurrentAction == MONSTER01_ATTACK2))
        {
            vec3_t Light;
    ...
    case MODEL_GIGANTIS:
    {
        if ((o->AnimationFrame >= 3.5f && o->AnimationFrame <= 5.9f && o->CurrentAction == MONSTER01_ATTACK1) ||
            (o->AnimationFrame >= 3.5f && o->AnimationFrame <= 5.9f && o->CurrentAction == MONSTER01_ATTACK2))
        {
            vec3_t Light;
            Vector(1.0f, 1.2f, 2.f, Light);
    ...
    case MODEL_GENOCIDER:
    {
        if ((o->AnimationFrame >= 5.5f && o->AnimationFrame <= 6.9f && o->CurrentAction == MONSTER01_ATTACK1) ||
            (o->AnimationFrame >= 5.5f && o->AnimationFrame <= 6.9f && o->CurrentAction == MONSTER01_ATTACK2))
        {
            vec3_t Light;
