...
void CMVP1STDirection::BeginDirection1()
{
    if (g_Direction.m_bAction)
    {
        ...
        else if (g_Direction.m_iCheckTime == 28)
        {
            ...
            g_Direction.GetTimeCheck(2000);
        else
            g_Direction.m_bAction = false;
    }
    else
    {
        QueueCameraMove(kBeginDirection1Fallback.x, kBeginDirection1Fallback.y, kBeginDirection1Fallback.z,
                        kBeginDirection1Fallback.speed);
    }
}
...
void CMVP1STDirection::BeginDirection2()
{
    if (g_Direction.m_bAction)
    {
        if (g_Direction.m_iCheckTime == 0)
        {
            ...
            {
                g_Direction.SummonCreateMonster(command.type, command.x, command.y, command.angle, command.nextCheck,
                                                command.summonAnimation, command.animationSpeed);
            }
        }
        else if (g_Direction.m_iCheckTime == 1)
        {
        ...
        QueueCameraMove(kBeginDirection2Fallback.x, kBeginDirection2Fallback.y, kBeginDirection2Fallback.z,
                        kBeginDirection2Fallback.speed);
}
...
void CMVP1STDirection::BeginDirection3()
{
    if (g_Direction.m_bAction)
    {
        ...
        QueueCameraMove(kBeginDirection3Fallback.x, kBeginDirection3Fallback.y, kBeginDirection3Fallback.z,
                        kBeginDirection3Fallback.speed);
}
...
void CMVP1STDirection::BeginDirection4()
{
    if (g_Direction.m_bAction)
    {
        ...
        QueueCameraMove(kBeginDirection4Fallback.x, kBeginDirection4Fallback.y, kBeginDirection4Fallback.z,
                        kBeginDirection4Fallback.speed);
}
