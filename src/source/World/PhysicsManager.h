...
public:
    virtual BOOL Create(OBJECT* o, int iBone, float fxPos, float fyPos, float fzPos, int iNumHor, int iNumVer,
                        float fWidth, float fHeight, int iTexFront, int TexBack, DWORD dwType = 0);
...
public:
    ...
    virtual BOOL Create(OBJECT* o, int iMesh, int iBone, float fxPos, float fyPos, float fzPos, int iNumHor,
